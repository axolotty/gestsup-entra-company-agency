...
INSERT INTO `tplugins` (`name`, `label`, `description`, `icon`, `version`) VALUES ('entra_company_agency','Sociétés Entra ID','Associe automatiquement une agence GestSup à chaque société Entra ID (companyName) lors de la connexion SSO Office 365','building','1.1');